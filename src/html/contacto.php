...
<html lang="es">
    ...
    <body>
        ...
        <nav aria-label="Navigation" class="navbar">
         <div class="container">
            ...
            <ul class="nav-links">
                  ...
                  <li><a href="/src/html/contacto.html" aria-current="page">Contacto</a></li>
        ...
        <div class="application-form-container">
            ...
            <form id="proyecto-form" class="application-form" action="/api/postular" method="POST">
                
                <!-- Protección CSRF (token simulado para el ejemplo) -->
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="nombre-proyecto" name="nombre_proyecto" required 
                    ...
                    <div class="form-group">
                        ...
                        <select id="sector" name="sector" required>
                            ...
                            <option value="seguridad">Seguridad VIP</option>
                            ...
                            <option value="transatlantico">Transatlántico</option>
                            <option value="hoteleria-turismo">Hotelería y Turismo</option>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="pais" name="pais" placeholder="Ej: Colombia, México...">
                    </div>
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="4" required
                              placeholder="Cuéntanos sobre tu modelo de negocio, tracción actual y potencial de crecimiento..."></textarea>
                </div>
                
                <div class="form-group full-width checkbox-group">
                    <input type="checkbox" id="terminos" name="terminos" required>
                    <label for="terminos">
                        Acepto la <a href="/src/html/politica-privacidad.html">política de privacidad</a> y el tratamiento de mis datos 
  ...
  <p>
    ...
    <span class="email-webmail-options">
      ...
      <a href="https://mail.google.com/mail/?view=cm&fs=1&to=inversiones@pfhghealth.com" 
         ...
         class="email-webmail-link" 
         title="Abrir en Gmail">
        Gmail
      </a>
      <span aria-hidden="true">·</span>
      <!-- Outlook: URL corregida -->
    ...
    <!-- Añade una segunda línea para más densidad -->
    <p style="margin-top: 1rem;">Transformamos capital en poder corporativo con integridad y visión a largo plazo.</p>
               ...
               <div class="footer-section">
                  ...
                  <ul>
                     ...
                     <li><a href="/src/html/Lineasnegocio.html">Expansión Internacional & Negocios Globales</a></li>
                  </ul>
               </div>
            </div>
